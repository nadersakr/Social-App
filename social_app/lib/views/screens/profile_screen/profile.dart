          ...
          SizedBox(
            child: Column(
              children: [
                SizedBox(
                  width: profileViewModel.wholeWidth,
                  height: profileViewModel.heightFromTop,
                ),
                Stack(
                  ...
                  children: [
                    ...
                    ClipPath(
                      ...
                      child: SizedBox(
                        width: profileViewModel.squareHeightAndWidth90,
                        height: profileViewModel.squareHeightAndWidth90,
                        child: Image.network(
                ...
                Row(
                  ...
                  children: [
                    TextClass.subTitleText(
                        profileViewModel.numberOfPostsString),
                    TextClass.subTitleText(
                    ...
                    child: MasonryGridView.count(
                      ...
                      itemBuilder: (context, index) {
                        return ClipRRect(
                            ...
                            child: Image.network(
                              authController.mainUser.posts![index]
                                      ['imageUrl'] ??
